	    ...
	    return (
	        React.DOM.div( {className:"imageBox"}, 
	            ReactTransitionGroup( {transitionName:"fade"}, 
	              ...
	              React.DOM.img( {src:this.props.imageURL, width:this.props.appWidth/2} )
	            )
	        )
	      )
	  }
...
/***/ function(module, exports, require) {
	...
	/* WEBPACK VAR INJECTION */(function(require, process) {module.exports = require(11);
