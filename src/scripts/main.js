	  ...
	  render: function() {
	    return (
	      React.DOM.div( {className:"app"}, 
	        ...
	        React.DOM.p(null, "Current window width: ", this.state.windowWidth)
	      )
	    );
	  }
	});
...
/***/ function(module, exports, require) {
	...
	var ImageBox = React.createClass({displayName: 'ImageBox',
	  render: function () {
	    return (
	        React.DOM.div( {className:"imageBox"}, 
	          React.DOM.p(null, "Image box width: ", this.props.appWidth),
	          React.DOM.img( {src:"https://fbcdn-sphotos-d-a.akamaihd.net/hphotos-ak-prn1/1010076_477783955633350_1900224762_n.png", width:this.props.appWidth/2} )
	        )
	      )
	  }
	});
...
/***/ function(module, exports, require) {
	...
	/* WEBPACK VAR INJECTION */(function(require, process) {module.exports = require(10);
	if ('production' !== process.env.NODE_ENV) {
	  module.exports = require(11).wrap(module.exports);
	}
...
/***/ function(module, exports, require) {
	...
	var ReactComponent = require(14);
	var ReactCompositeComponent = require(15);
...
/***/ function(module, exports, require) {
	...
	exports.binding = function (name) {
	    if (name === 'evals') return (require)(28)
...
/***/ function(module, exports, require) {
	...
	var ReactOwner = require(31);
	var ReactPerf = require(23);
	var ReactPropTransferer = require(37);
	var ReactUpdates = require(32);

	var invariant = require(33);
	var keyMirror = require(34);
	var merge = require(35);
	var mixInto = require(38);
...
/***/ function(module, exports, require) {
	...
	var CSSPropertyOperations = require(42);
	var DOMProperty = require(43);
	var DOMPropertyOperations = require(44);
	var ReactComponent = require(14);
	var ReactEventEmitter = require(45);
	var ReactMultiChild = require(22);
	var ReactMount = require(21);
	var ReactPerf = require(23);

	var escapeTextForBrowser = require(46);
	var invariant = require(33);
...
/***/ function(module, exports, require) {
	...
	var ReactEventEmitter = require(45);
	var ReactEventTopLevelCallback = require(54);
	var ReactPerf = require(23);
	...
	var EventPluginHub = require(60);
	var MobileSafariClickEventPlugin = require(61);
	var ReactInstanceHandles = require(20);
	var SelectEventPlugin = require(62);
	var SimpleEventPlugin = require(63);

	var ReactDefaultBatchingStrategy = require(64);
	var ReactUpdates = require(32);
	...
	function inject() {
	  ...
	  if ("production" !== process.env.NODE_ENV) {
	    ReactPerf.injection.injectMeasure(require(65).measure);
	  }
...
/***/ function(module, exports, require) {
	...
	var ReactComponent = require(14);
	var ReactMultiChildUpdateTypes = require(69);

	var flattenChildren = require(70);
...
/***/ function(module, exports, require) {
	...
	if ("production" !== process.env.NODE_ENV) {
	  var ExecutionEnvironment = require(71);
...
/***/ function(module, exports, require) {
	...
	var createObjectFrom = require(72);
	var invariant = require(33);
...
/***/ function(module, exports, require) {
	...
	/* WEBPACK VAR INJECTION */(function(require, process) {var filter = require(77);
...
/***/ function(module, exports, require) {
	...
	var CSSProperty = require(82);

	var dangerousStyleValue = require(83);
	var escapeTextForBrowser = require(46);
	var hyphenate = require(84);
	var memoizeStringOnly = require(85);
...
/***/ function(module, exports, require) {
	...
	var invariant = require(33);
	var isEventSupported = require(90);
	var merge = require(35);
...
/***/ function(module, exports, require) {
	...
	var DOMPropertyOperations = require(44);
	var LinkedValueMixin = require(91);
	var ReactCompositeComponent = require(15);
	var ReactDOM = require(17);
	var ReactMount = require(21);
...
/***/ function(module, exports, require) {
	...
	var ExecutionEnvironment = require(71);
	var SyntheticEvent = require(94);

	var isEventSupported = require(90);
	var isTextInputElement = require(95);
	var keyOf = require(47);
...
/***/ function(module, exports, require) {
	...
	var EventPropagators = require(93);
	var ExecutionEnvironment = require(71);
	var ReactInputSelection = require(96);
	var SyntheticCompositionEvent = require(97);

	var getTextContentAccessor = require(98);
	var keyOf = require(47);
...
/***/ function(module, exports, require) {
	...
	var EventConstants = require(86);
	var EventPropagators = require(93);
	var SyntheticMouseEvent = require(99);
...
/***/ function(module, exports, require) {
	...
	var CallbackRegistry = require(100);
	var EventPluginRegistry = require(101);
	var EventPluginUtils = require(102);
	var EventPropagators = require(93);
	var ExecutionEnvironment = require(71);

	var accumulate = require(103);
	var forEachAccumulated = require(104);
	var invariant = require(33);
...
/***/ function(module, exports, require) {
	...
	var getActiveElement = require(105);
	var isTextInputElement = require(95);
	var keyOf = require(47);
...
/***/ function(module, exports, require) {
	...
	var SyntheticEvent = require(94);
	var SyntheticFocusEvent = require(108);
	var SyntheticKeyboardEvent = require(109);
	var SyntheticMouseEvent = require(99);
	var SyntheticTouchEvent = require(110);
	var SyntheticUIEvent = require(111);
	var SyntheticWheelEvent = require(112);
...
/***/ function(module, exports, require) {
	...
	var performanceNow = require(114);
...
/***/ function(module, exports, require) {
	...
	var invariant = require(33);
	var traverseAllChildren = require(118);
...
/***/ function(module, exports, require) {
	...
	var ExecutionEnvironment = require(71);
	var PooledClass = require(120);
	var ReactEventEmitter = require(45);
	var ReactInputSelection = require(96);
	var ReactMountReady = require(121);
	var Transaction = require(113);
...
/***/ function(module, exports, require) {
	...
	var ReactDOMSelection = require(125);
...
/***/ function(module, exports, require) {
	...
	var createNodesFromMarkup = require(128);
	var filterAttributes = require(129);
	var invariant = require(33);
...
/***/ function(module, exports, require) {
	...
	var getNodeForCharacterOffset = require(130);
	var getTextContentAccessor = require(98);
...
/***/ function(module, exports, require) {
	...
	var createArrayFrom = require(132);
